...
//cement products data
const cementProducts = [
  {
    productID: 'CMT-OPC-53-001',
    productName: 'Ordinary Portland Cement (OPC) 53 Grade',
    description: 'High-strength OPC 53 Grade cement ideal for high-rise buildings, bridges, and heavy concrete structures. Provides superior compressive strength and faster setting time.',
    price: 380,
    stockQuantity: 50000,
    productImage: 'https://raw.githubusercontent.com/founders-core/E-commerce-website-beta-test/refs/heads/main/Frontend/public/greencement.png',
    productRating: 4.8,
    categoryName: 'Cement'
  },];


  // Plaster Products Data
const plasterProducts = [
  {
    productID: 'PLS-CP-001',
    productName: 'Cement Plaster - Premium Grade',
    description: 'Premium quality cement plaster mix for internal and external walls. Provides excellent adhesion, crack resistance, and smooth finish.',
    price: 420,
    stockQuantity: 30000,
    productImage: 'https://raw.githubusercontent.com/founders-core/E-commerce-website-beta-test/refs/heads/main/Frontend/public/plaster.png',
    productRating: 4.7,
